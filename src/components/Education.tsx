...
const GridItem = ({ area, icon, title, description, logo }: GridItemProps) => {
  return (
    <li className={`min-h-[14rem] list-none relative z-20 ${area}`}>
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3">
        <GlowingEffect
          ...
          inactiveZone={0.01}
        />
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-6 bg-black dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
