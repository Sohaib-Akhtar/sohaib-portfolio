...
export const FloatingDock = ({
  ...
  return (
    <>
      ...
      <FloatingDockResponsive items={items} className={mobileClassName} />
    </>
  );
};
...
const FloatingDockResponsive = ({
  ...
  return (
    <motion.div
      ...
      onMouseLeave={() => mouseX.set(Infinity)}
      className={cn(
        "mx-auto flex h-14 items-end gap-3 rounded-2xl bg-gray-50 px-3 pb-2 md:hidden dark:bg-neutral-900 scale-90",
        className,
      )}
    >
      {items.map((item) => (
